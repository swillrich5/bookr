    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='The email address of the contributor.', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_edited', models.DateField(help_text='The date/time the review was last edited.', null=True)),
                ('book', models.ForeignKey(help_text='The book being reviewed.', on_delete=django.db.models.deletion.CASCADE, to='reviews.book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'Author'), ('CO_AUTHOR', 'Co-Author'), ('EDITOR', 'Editor')], max_length=20, verbose_name='The role this contributor played in the book.')),
